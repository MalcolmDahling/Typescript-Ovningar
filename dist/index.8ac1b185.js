...
})({"jYhA6":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "2a316c078ac1b185";
...
},{}],"2AVe2":[function(require,module,exports) {
...
class Main {
    start(service1) {
        ...
        document.getElementById('searchButton').addEventListener('click', function() {
            if (document.getElementById('movies')) document.getElementById('movies').remove();
            ...
            let movieArray = service1.GetData(searchMovie);
            movieArray.then((data)=>{
                console.log(data.Search);
                for(let i = 0; i < data.Search.length; i++)document.getElementById('movies').insertAdjacentHTML('beforeend', `
...
let main = new Main();
let service = new _service.Service();
main.start(service);

},{"../services/Service":"hI0SA"}],"hI0SA":[function(require,module,exports) {
...
},{}]},["jYhA6","2AVe2"], "2AVe2", "parcelRequire94c2")

//# sourceMappingURL=index.8ac1b185.js.map
